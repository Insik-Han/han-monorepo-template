...
- rationale: vp test does not support --filter flag; document that tests must be run from packages/ subdirectories, not from root
- evidence: session 2c0338de (self-evolution bootstrap)
- hash: 25361fb7
